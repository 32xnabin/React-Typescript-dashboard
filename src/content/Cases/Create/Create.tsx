...
import { uploadImage } from '../../../services/cases';
...
interface IProps {
  cases?: Myboscase[];
  addCase?: (caseObj: Myboscase) => void;
  fetchCases?: () => void;
}

const Create: React.FC<IProps> = ({ addCase, fetchCases, cases }) => {
  ...
  useEffect(() => {
    setCasenum(Number(cases[0].case_number) + 1);
  ...
  const createNewCase = (data: Myboscase) => {
